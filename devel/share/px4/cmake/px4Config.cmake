...
if("TRUE" STREQUAL "TRUE")
  set(px4_SOURCE_PREFIX /home/wonsik/catkin_ws/src/Firmware)
  set(px4_DEVEL_PREFIX /home/wonsik/catkin_ws/devel)
  set(px4_INSTALL_PREFIX "")
  set(px4_PREFIX ${px4_DEVEL_PREFIX})
else()
  set(px4_SOURCE_PREFIX "")
  set(px4_DEVEL_PREFIX "")
  set(px4_INSTALL_PREFIX /home/wonsik/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Lorenz Meier <lorenz@px4.io>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wonsik/catkin_ws/src/Firmware/${idir}'.  Ask the maintainer 'Lorenz Meier <lorenz@px4.io>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${px4_dep}_FOUND)
      find_package(${px4_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${px4_dep} REQUIRED ${depend_list})
  endif()
